    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="/">
            <div class="nav-logo-container">
                <img src="assets/images/logo.svg" alt="Eureka Forbes" class="nav-logo">
            </div>
        </a>

        <!-- Mobile Menu Toggle -->
        <button class="navbar-toggler mobile-menu-toggle d-lg-none" type="button"
        ...
        <div class="navbar-actions d-none d-lg-flex align-items-center">
            ...
            <div class="phone-display d-flex align-items-center ms-3">
                <div class="status-badge">
                    <a href="tel:<?php echo BUSINESS_PHONE; ?>" class="text-decoration-none" title="Call Us">
